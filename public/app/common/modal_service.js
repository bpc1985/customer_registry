angular.module('app').service('crModalService', function($modal, $location){
    var modalDefaults = {
        backdrop: true,
        keyboard: true,
        modalFade: true,
    ...
    var modalOptions = {
        closeButtonText: 'Ei',
        actionButtonText: 'Kyllä',
        headerText: 'Siirtyä?',
        bodyText: 'Haluatko siirtyä toiselle sivulle tallentamatta tietoja?'
    };
    ...
    this.displayModal = function(event, newUrl, form, onRouteChangeOff, modalOptions){
